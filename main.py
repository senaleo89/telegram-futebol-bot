...
async def status(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("✅ Bot online e monitorando partidas!")

async def teste(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("✅ Teste realizado com sucesso!")
    ...
    try:
        ...
        for jogo in dados.get("response", []):
            ...
            try:
                ...
                for time_stats in stats_dados.get("response", []):
